    ...
    <Container className={styles.profilePage__container}>
      ...
      <Paper className={styles.profilePage__sectionPaper}>
        <Group className={styles.profilePage__userInfo}>
          ...
          />
          <Stack gap="xs">
            <Title order={2} className={styles.profilePage__userName}>
              {mockUser.name}
            </Title>
            <Text className={styles.profilePage__joinDate}>
      ...
      <Paper
        className={`${styles.profilePage__sectionPaper} ${styles.profilePage__stravaSection}`}
      >
        <Group className={styles.profilePage__stravaStatusGroup}>
          <Title order={3} className={styles.profilePage__sectionHeader}>
            Strava Sync Status
          </Title>
      ...
      <Paper className={styles.profilePage__sectionPaper}>
        ...
        <SimpleGrid cols={{ base: 1, sm: 3 }} spacing="lg">
          <Box className={styles.profilePage__summaryCard}>
            <Text className={styles.profilePage__summaryValue}>
              {mockRunSummaries.totalRuns}
            </Text>
            <Text className={styles.profilePage__summaryLabel}>Total Runs</Text>
          </Box>
          <Box className={styles.profilePage__summaryCard}>
            <Text className={styles.profilePage__summaryValue}>
              {mockRunSummaries.totalDistance}
            </Text>
            <Text className={styles.profilePage__summaryLabel}>
              Total Distance
            </Text>
          </Box>
          <Box className={styles.profilePage__summaryCard}>
            <Text className={styles.profilePage__summaryValue}>
              {mockRunSummaries.totalTime}
            </Text>
            <Text className={styles.profilePage__summaryLabel}>
        ...
        <Stack gap="sm">
          {mockPersonalBests.map((pb) => (
            <Group
              ...
              className={styles.profilePage__pbItem}
            >
